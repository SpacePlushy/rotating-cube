...
const Cube = ({ rotationSpeed = 0.01, color = '#00ff00', wireframe = false, shape = 'cube', onRotationDirectionChange, onResetRotation }) => {
    ...
    const handleManualRotation = useCallback((xDelta, yDelta) => {
        if (cubeRef.current) {
            rotationRef.current = {
    ...
    useEffect(() => {
        ...
        if (typeof onRotationDirectionChange === 'function') {
            ...
            const handler = (x, y) => handleManualRotation(x, y);
    ...
    return _jsx("div", { className: "cubeContainer", ref: mountRef, "data-testid": "cube-container", "data-shape": shape, "data-color": color, "data-wireframe": wireframe.toString() });
};
export default Cube;
